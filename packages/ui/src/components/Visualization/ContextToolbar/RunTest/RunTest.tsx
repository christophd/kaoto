...
import { PlayIcon, PauseIcon, ExclamationIcon, CheckIcon } from '@patternfly/react-icons';
          ...
          if (json.status === "UP") {
            ...
            .finally(() => {
              ...
              .then(json => {
                ...
                const result :TestReportEntry = results?.find(t => t.name === testName) as TestReportEntry || undefined;
                if (result) {
