...
export const EndpointFieldInner: FunctionComponent<EndpointFieldProps> = ({ propName, model, endpointType, setEndpointType, onModelChange }) => {
  ...
  }, [oneOfSchemas, onSchemaChange, onModelChange]);
