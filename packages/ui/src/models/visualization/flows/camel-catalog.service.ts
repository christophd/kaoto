...
export class CamelCatalogService {
  ...
  static getComponent(catalogKey: CatalogKind.TestActionGroup, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(catalogKey: CatalogKind.TestAction, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(catalogKey: CatalogKind.TestContainer, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(catalogKey: CatalogKind.TestEndpoint, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(catalogKey: CatalogKind.TestFunction, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(catalogKey: CatalogKind.TestValidationMatcher, componentName?: string): ICitrusComponentDefinition | undefined;
  static getComponent(
